...
export const causes = [
    { phoneDetails: timeCyclePhone, text: "Time Cycle", image: clock, details: time, id: 0 },
    { phoneDetails: astroCyclePhone, text: "Astro Cycle", image: globe, details: astro, id: 1 },
    { phoneDetails: gannPhone, text: "WD Gann Methods", image: books, details: gann, id: 2 },
    { phoneDetails: dateCycleDetails, text: "Date Cycles", image: calender, details: dateCyclePC, id: 3 },
    { phoneDetails: dynStatPhone, text: "Dynamic & Static Levels", image: bars, details: dynamicAndStatic, id: 4 },
    { phoneDetails: advOptPhone, text: "Advance Option Strategies", image: options, details: advanceOptionStrategies, id: 5 },
    { phoneDetails: elliotPhone, text: "Elliott Waves", image: eliteWave, details: elliotwaves, id: 6 },
    { phoneDetails: priceActPhone, text: "Master of Price Action", image: priceAction, details: masterofPrice, id: 7 },
    { phoneDetails: bigfootDetails, text: `Bigfoot Player Entries`, image: bigFoot, details: bigfoot, id: 8 },
    { phoneDetails: psycoPhone, text: "Psychology buildup", image: physicology, details: Psychology, id: 9 },
    { phoneDetails: riskDetails, text: "Risk Management", image: riskManagement, details: Riskmanagement, id: 10 },
    { phoneDetails: communitySupport, text: "Community Support", image: community, details: communitySupport, id: 11 },
];
...
const causesSmall = [
    ...
    { phoneDetails: dynStatPhone, text: "Dynamic & Static Levels", image: bars, details: dynamicAndStatic, id: 4 },
    { phoneDetails: dateCycleDetails, text: "Date Cycles", image: calender, details: dateCyclePC, id: 3 },
    { phoneDetails: advOptPhone, text: "Adv. Option Strategies", image: options, details: advanceOptionStrategies, id: 5 },
    { phoneDetails: elliotPhone, text: "Elliott Waves", image: eliteWave, details: elliotwaves, id: 6 },
    { phoneDetails: priceActPhone, text: "Master of Price Action", image: priceAction, details: masterofPrice, id: 7 },
    { phoneDetails: bigfootDetails, text: `Bigfoot Player Entries`, image: bigFoot, details: bigfoot, id: 8 },
    { phoneDetails: psycoPhone, text: "Psychology buildup", image: physicology, details: Psychology, id: 9 },
...
const Header = () => {
    ...
    return (
        <>
        <header className='z-10 relative bg-[length:120vw] lg:bg-cover' id='homepage'>
            <h1 className='text-[38px] -z-10 relative uppercase lg:text-[107px] pt-10 lg:pt-0 font-black text-[#83FF8F] text-center mb-[14px] leading-[48px] lg:leading-[116px] drop-shadow-[0_0_4px_#83FF8F]' ref={headerRef}>
                Growcial Bull
            </h1>
            <h6 className='text-white -z-10 font-light uppercase lg:font-bold text-[14px] lg:text-[28px] tracking-[0.3em] text-center relative drop-shadow-[0_0_6px_#fff]' ref={subHeaderRef}>
                Learn Gain & Grow
            </h6>
            <div className='text-center mt-[38px] lg:mb-[100px] relative z-1 mx-auto'>
                <a href="https://chat.whatsapp.com/LYZFkiXpuJTF0J5Cxh9lSW" className='px-[18px] py-[11px] text-[12px] lg:text-[22px] text-[#83FF8FC9] rounded-full drop-shadow-[0_0_6px_#83FF8FB2] border-[1px] tracking-[0.3em] border-[#83FF8FB2] focus:text-white hover:drop-shadow-[0_0_0_#fff] focus:bg-[#83FF8F69] transition' target='_blank' rel='noreferrer' ref={buttonRef}>Join  Community</a>
            </div>

            <div className='mt-[20px] lg:mt-[40px] flex flex-col lg:flex-row lg:px-[116px] items-center relative' ref={reasonRef}>
                <div className='w-11/12 lg:w-5/12 lg:text-left'>
                    <h1 className='hidden lg:block text-[22px] lg:text-[38px] font-black'>
                        ...
                        <span className='text-[#83FF8F] hidden lg:block'> Growcial Bull.</span>
                ...
                <div className='px-10 lg:w-7/12 lg:mt-0 text-white overflow-visible causes'>
                    ...
                    <div className="hidden lg:block">
                        <OwlCarousel className='owl-theme' items={1} autoplay={2} loop autoplayHoverPause>
                            <div className="grid grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-0 w-full py-10 lg:pl-[60px] item overflow-x-visible overflow-y-hidden">
                                {causes.slice(0, 6).map(({ image, text, details, phoneDetails, id }) => <CauseSmall key={id} img={image} title={text} details={details} id={id} phoneDetails={phoneDetails} />)}
                            </div>
                            <div className="grid grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-0 w-full py-10 lg:pl-[60px] item overflow-x-visible overflow-y-hidden">
                                {causes.slice(6, causes.length).map(({ image, text, details, phoneDetails, id }) => <CauseSmall key={id} img={image} title={text} details={details} id={id} phoneDetails={phoneDetails} />)}
                            </div>
                        </OwlCarousel>
                    </div>

                    <div className="lg:hidden">
                        <OwlCarousel className='owl-theme lg:hidden' items={1} autoplay={2} autoplayHoverPause loop>
                            <div className="grid grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-0 w-full py-10 lg:pl-[60px] item overflow-x-visible overflow-y-hidden">
                                {causesSmall.slice(0, 6).map(({ image, text, details, phoneDetails, id }) => <CauseSmall key={id} img={image} title={text} details={details} id={id} phoneDetails={phoneDetails} />)}
                            </div>
                            <div className="grid grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-0 w-full py-10 lg:pl-[60px] item overflow-x-visible overflow-y-hidden">
                                {causesSmall.slice(6, causesSmall.length).map(({ image, text, details, phoneDetails, id }) => <CauseSmall key={id} img={image} title={text} details={details} id={id} phoneDetails={phoneDetails} />)}
                            </div>
                        </OwlCarousel>
                    </div>
                    {/* </div> */}
